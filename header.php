...
<head>
    ...
    <title>Home | Dabi Gown Rentals</title>
</head>
    ...
    <section id="#navbar">
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top shadow lh-1">
            <a class="navbar-brand img-fluid ms-2" href="index.php">
                <img src="Img/assets/logo.png" alt="logo" height="40vw" /></a>
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                ...
                <form method="get" action="search.php" class="d-flex" id="searchBar">
                    <input class="form-control" type="text" name="search" placeholder="Search by Dress Name..." />
