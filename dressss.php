...
<div class="container-fluid py-5">
    <div class="row mb-3">
        ...
        <div class="col-12 col-md-9">
            <h2 id="Dress Name" class="text-uppercase font-weight-bold"><?php echo $getProduct['0']['name'] ?></h2>
            <hr>
            <h6>DSN:- <span class="fw-normal"><?php echo $getProduct['0']['DSN'] ?></span></h6>
            <p></p>
            <p>
            ...
            <?php
            $qtySql = mysqli_query($con, "select qty from dress where id='$bookId'");
            ...
            <div id="after-rent" class="mb-4">
                <form method="get">
                    ...
                    <h4 class="mb-3">Enter the duration of renting in days (minimum of 3 days)</h4>
                    <div class="col-2 d-flex">
                        <input type="number" class="form-control" name="duration" min="3" max="200" placeholder="Days"
                            required />
