...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($con, "INSERT INTO order_detail(order_id,dress_id,price,time)
                                VALUES ('$orderId', '$productId', '$totalPrice', '$duration')");

    $newQty = $getProduct['0']['qty'] - 1;
    mysqli_query($con, "UPDATE dress SET qty = '$newQty' WHERE id='$dressId';");
?>
<script>
...
?>
<script>
document.title = "Checkout | Dress Rental";
</script>
<div class="container">
    <main>
        ...
        <div class="row g-5">
            <div class="col-md-5 col-lg-4 order-md-last">
                <h4 class="d-flex justify-content-between align-items-center mb-3">
                    <span class="text-primary">Your Dress</span>
                </h4>
                <ul class="list-group mb-3 dark-background">
                    ...
                    <li class="list-group-item justify-content-start lh-sm">
                        ...
                        <p><span class="fw-bold">Rent Price</span> = P<?php echo $getProduct['0']['rent'] ?> Per Day
                        </p>
                        <p><span class="fw-bold">Duration</span> = <?php echo $duration ?> Days</p>
                        <p><span class="fw-bold">Total Rent</span> = P<?php echo $totalRent ?></p>
                        <p><span class="fw-bold">Security Deposit<span style="color: red"><sup>*</sup></span></span> =
                            P<?php echo $getProduct['0']['security'] ?></p>
                        <p><span class="fw-bold">Total price</span> = P<?php echo $totalPrice ?> </p>
                    </li>
                </ul>
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item justify-content-start lh-sm">
                        <ol type="1">
                            <li>
                                Delivery person should take a picture as a proof of successful delivery
                            </li>
                            <li>
                                Security Deposit is refundable once we receive the dress in the proper condition.
                            </li>
                        </ol>
                    </li>
                </ul>
                ...
                <form class="needs-validation" method="post" novalidate>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="address" placeholder="House no. / Blk no. / Street / Barangay" required>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="address2" placeholder="Province / City" required>
                        </div>

                        <div class="col-3">
                            <label for="pin" class="form-label">Zip Code</label>
                            <input type="number" maxlength="6" class="form-control" name="pin" placeholder="5000"
                                required>
                            <div class="invalid-feedback">
                                Zip code required.
                            </div>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-check">
                            <input id="payU" name="paymentMethod" type="radio" value="payU" class="form-check-input"
                                required disabled>
                            <label class="form-check-label" for="payU">Online Payment (Currently Unavailable)   </label>
                        </div>
                    </div>
