...
(22, 4, '1000', 'Azure Elegance', 'azureelegance.png', 800, 2400, 1, NULL, 'Azure Colored Americana', 'The Azure Elegance is an Americana ensemble that effortlessly combines classic style with a touch of European sophistication. This stylish ensemble features a captivating blue jacket and a crisp white shirt, creating a visually stunning and refined look.', 1),
(23, 4, '2000', 'Golden Threads', 'Golden Threads.png', 850, 3000, 1, NULL, 'A golden colored Americana', 'The Golden Threads Americana is a striking and sophisticated jacket that embodies the essence of timeless elegance. Crafted with meticulous attention to detail, this yellow jacket features exquisite gold embroidery that adds a touch of opulence to its overall design. The unique and stylish silhouette of the jacket sets it apart from traditional outerwear, making it a standout piece in any wardrobe.', 1),
(24, 5, '3000', 'Golden Opulence', 'Golden Opulence.png', 750, 2500, 1, NULL, 'A golden colored Barong.', 'The Golden Opulence Barong is a magnificent and regal attire that embodies the rich cultural heritage of the Philippines. This traditional Filipino garment features a pristine white fabric adorned with intricate gold embroidery, symbolizing prosperity and elegance. The barong is expertly crafted to highlight the beauty of its design, with meticulous attention to detail evident in every stitch.', 1),
(25, 4, '3000', 'Fusion Heritage', 'Fusion Heritage Jacket.png', 800, 3000, 1, NULL, 'American Style with cultural blend Americana.', 'The Fusion Heritage Jacket is a remarkable blend of classic American style and traditional cultural influences. This modern jacket seamlessly combines elements from both worlds, creating a unique and captivating aesthetic. With its black and white color scheme, the jacket exudes a sense of sophistication and versatility. The use of high-quality materials, such as cotton or linen, ensures comfort and durability. The well-fitted design showcases the wearer\'s discerning taste and keen eye for fashion.', 1),
(26, 4, '4000', 'Cross-Cultural Elegance', 'Cross-Cultural Elegance.png', 750, 2800, 1, NULL, 'Blue and White Colored Americana', 'The Cross-Cultural Elegance Jacket is a true masterpiece that beautifully blends American style with traditional cultural influences. Its striking black and white color scheme creates a visually captivating contrast, while the intricate patterns and designs reflect a harmonious fusion of diverse cultural elements. Crafted from premium materials like cotton or linen, this jacket ensures both comfort and durability. The well-fitted design accentuates the wearer\'s refined taste and eye for fashion.', 1),
(27, 5, '4000', 'Diamond Prism', 'Diamond Prism.png', 650, 1500, 1, NULL, 'A Filipino inspired Barong.', 'The Diamond Prism Barong is a captivating example of traditional Filipino attire, exuding elegance and cultural richness. Crafted from a lightweight fabric, this barong features a pristine white base adorned with a geometric pattern that resembles dazzling diamond prisms. The intricate design extends gracefully across the front and back of the shirt, showcasing the meticulous craftsmanship. The well-lit image allows for a clear view of the intricate details and the way the pattern gracefully enhances the shirt\'s overall appeal. The Diamond Prism Barong is a testament to the wearer\'s appreciation for Filipino heritage and their desire to showcase it with style and sophistication.', 1),
(28, 5, '5000', 'Prismatic Elegance', 'Prismatic Elegance.png', 750, 2000, 1, NULL, 'A white Barong with geometric patterns.', 'The Prismatic Elegance Barong is a stunning embodiment of modern sophistication and cultural heritage. Crafted with meticulous attention to detail, this exquisite white barong showcases a mesmerizing geometric pattern that evokes a sense of depth and dimension. The sleek and clean design of the shirt, along with its well-lit presentation, exudes a contemporary allure. The Prismatic Elegance Barong pays homage to traditional Filipino attire while embracing a modern aesthetic, making it a perfect choice for those seeking a stylish blend of heritage and elegance.', 1),
(29, 5, '6000', 'Golden Heritage', 'Golden Heritage .png', 600, 1500, 1, NULL, 'A traditional Baron with golden patterns.', 'The Golden Heritage Barong is a magnificent representation of Filipino cultural heritage and timeless elegance. This traditional white barong features a meticulously crafted gold pattern that adds a touch of opulence to its overall design. With its button-up style and classic collared neckline, this barong exudes sophistication and refinement. The carefully positioned mannequin showcases the shirt\'s impeccable fit and highlights the intricate gold pattern, making it a visually captivating piece. The Golden Heritage Barong is a perfect choice for those seeking to embrace their cultural roots while making a stylish statement.', 1);
