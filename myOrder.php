...
?>
<script>
document.title = "My Orders | Dres Rental";
</script>
    ...
    <table class="table table-responsive">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php if ($row['status_name'] === 'Cancelled' || $row['status_name'] === 'Delivered' || $row['status_name'] === 'Processing' || $row['status_name'] === 'Returned' || $row['status_name'] === 'Shipped' ) {
                            
                        } else if($row['status_name'] === 'Pending'){
